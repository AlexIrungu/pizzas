...
p1 = Pizza.create(name:"Cheese Pizza",ingredients:"Butter, Wheat, Cheese")
p2 = Pizza.create(name:"Vanilla Pot Pie",ingredients:"Dough, Milk, Vanilla")
p3 = Pizza.create(name:"Strawberry Slurp",ingredients:"Butter, Tomato, Strawberry")
p4 = Pizza.create(name:"Chocolate Maple",ingredients:"Coconut, Milk, Chocolate, Maple")
p5 = Pizza.create(name:'Peporoni',ingredients:"Mango, Wheat, Peporoni") 
